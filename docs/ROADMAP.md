...
| 3 | **Weekly digest** | Seven days of adherence, time-in-range, new labs, limit crossings | Shipped |
| 4 | **Calendar as the reminder channel** | Med and glucose nudges as events with phone alarms; adherence is the highest-value signal | Shipped |
